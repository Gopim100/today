...
{/* 
                  ...
                  {addSubtitle ? (
                    <>
                      ...
                      {!inputdisable ? (<div className="col-lg-12">
                        <div className="form-group">
                          <div className="flex flex-row justify-between align-items-center mr-3">
                            <label class="flex">Sub Title </label>
                          </div>
                      ...
                      <button class="flex flex-start bg-orange-400 w-40 h-8 text-center rounded my-2"  onclick={()=>{
                      ...
                      <button class="flex flex-start bg-orange-400 w-40 h-8 text-center rounded my-2">Content</button>
                    </>
                  ) : null}
